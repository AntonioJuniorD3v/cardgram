...
<head>
    ...
    <link rel="stylesheet" href="../../assets/vendor/toolbar/toolbar.css">
    <link rel="stylesheet" href="../../assets/vendor/animsition/animsition.css">
    <link rel="stylesheet" href="../../assets/vendor/asscrollable/asScrollable.css">
    <link rel="stylesheet" href="../../assets/vendor/switchery/switchery.css">
    <link rel="stylesheet" href="../../assets/vendor/intro-js/introjs.css">
    ...
    <link rel="stylesheet" href="../../assets/examples/css/uikit/icons.css">
    <link rel="stylesheet" href="../../assets/vendor/select2/select2.css">
    ...
    <link href="../../assets/vendor/emoji/lib/css/emoji.css" rel="stylesheet">
    ...
    <link rel="stylesheet" href="../../assets/vendor/ladda/ladda.css">
    <link rel="stylesheet" href="../../assets/examples/css/uikit/buttons.css">
    <link rel="stylesheet" href="./assets/css/cardClientAdmin.css">
    ...
    <script src="../../assets/vendor/colorPicker/js/prism.js"></script>
    <script src="../../assets/vendor/colorPicker/js/jquery-asColor.js"></script>
...
<body class="animsition dashboard" id="seloko">
    ...
    <div id="overlay" style="z-index:99999;">
  ...
  <nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega navbar-inverse colorSite"
    role="navigation" style="z-index:50;">
    <div class="navbar-container container-fluid">
      ...
      <div class=" navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
        ...
        <a class="px-1 w-100 h-50 waves-effect waves-light waves-round" href="{{url('pro')}}"style="
          ...
          <a class="nav-link dropdown-toggle px-2" data-toggle="dropdown" href="#" aria-haspopup="true"
            aria-expanded="false"> {{auth()->user()->name}} <span class="caret"></span></a>
          <div class="dropdown-menu" role="menu">
            <a class="dropdown-item" href="{{$BASE_URL}}perfil" role="menuitem"><i class="icon md-account"
                aria-hidden="true"></i> Perfil</a>
            <a class="dropdown-item" href="{{$BASE_URL}}logout" role="menuitem"><i class="icon md-power"
